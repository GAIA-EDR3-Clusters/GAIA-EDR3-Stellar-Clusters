...
#plt.ylim(pmdec0-pm_rmax*pm_sigma_width_multiplier,pmdec0+pm_rmax*pm_sigma_wid#th_multiplier)
...
plt.ylabel("Gmag")
plt.ylim(18.5,5)
plt.text(0.1, 0.95, '(c)', horizontalalignment='center', verticalalignment='center', transform=ax.transAxes)
...
plt.ylim(18.5,5)
#plt.legend()
plt.text(0.1, 0.95, '(d)', horizontalalignment='center', verticalalignment='center', transform=ax.transAxes)
...
plt.ylabel("Gmag")
plt.ylim(18.5,5)
plt.text(0.1, 0.95, '(e)', horizontalalignment='center', verticalalignment='center', transform=ax.transAxes)
